...
//   * }}}
//   */
//  def localDateReads[T](parsing: T,
//                        corrector: String => String = identity)(implicit p: T => TemporalParser[LocalDate]): Reads[LocalDate] =
//    new Reads[LocalDate] {
...
//   * }}}
//   */
//  def localTimeReads[T](parsing: T,
//                        corrector: String => String = identity)(implicit p: T => TemporalParser[LocalTime]): Reads[LocalTime] =
//    new Reads[LocalTime] {
